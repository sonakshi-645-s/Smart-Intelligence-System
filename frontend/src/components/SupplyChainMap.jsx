  ...
  return (
    <div className="glass-card p-4 sm:p-5 rounded-2xl relative overflow-hidden border border-stone-800">
      ...
      <div className="h-[440px] w-full rounded-xl overflow-hidden relative border border-stone-800">
        <MapContainer
          key={`${active_warehouse.warehouse_id || active_warehouse.name}-${active_warehouse.latitude}-${active_warehouse.longitude}`}
          ...
          zoomControl={false}
        >
          <MapRecenter center={[active_warehouse.latitude, active_warehouse.longitude]} />
