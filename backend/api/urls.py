...
from .views import (
    ...
    StaffingCalculationView,
    DeviseScenarioPlanView,
...
urlpatterns = [
    ...
    path('recommendations/devise-plan/', DeviseScenarioPlanView.as_view(), name='recommendation-devise-plan'),
    path('recommendations/<str:rec_id>/apply/', ApplyRecommendationView.as_view(), name='recommendation-apply'),
    path('staffing/calculate/', StaffingCalculationView.as_view(), name='staffing-calculate'),
    
    # Digital Twin Simulation (Simulator)
